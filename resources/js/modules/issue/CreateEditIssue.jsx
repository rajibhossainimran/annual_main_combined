...
export default function CreateEditIssue() {
  ...
  const [cmhList, setCmhList] = useState([])
  ...
  useEffect(() => {
    axios.get(window.app_url + '/cmh-list').then((res) => {
      setCmhList(res.data)
    })
...
{/*              <div className='col-md-12'>
            ...
            <div className='row my-3'>
              <div className='col-md-12 gap-2'>
               <b className='mb-2 text-danger'> OH COME ON</b>
              </div>
              <div className='col-md-12 gap-2'>
...
if (document.getElementById('react-issue-manual')) {
  createRoot(document.getElementById('react-issue-manual')).render(<CreateEditIssue/>)
}
