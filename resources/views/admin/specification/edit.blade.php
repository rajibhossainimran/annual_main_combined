                ...
                <div class="main-card app-content-inner card">
                    <div class="card-body">
                        <div class="card-title d-flex justify-content-between align-items-center table-header-bg py-1">
                            <h5 class="f-14">Update Specification</h5>
                        ...
                        <div class="pb-2">
                            <form action="{{route('update.specification')}}" method="post">
                                @csrf
                                <input type="hidden" name="id" value="{{$specification->id}}">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Name <span class="requiredStar">*</span></label>
                                        <input type="text" placeholder="Specification Name" required class="form-control" name="name" value="{{ $specification->name }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="mt-1">
                                        <button type="submit" class="btn btn-primary mt-1">Update specification</button>
                                    </div>
                                </div>
                            </form>
                        </div>
