...
<div class="app-main__outer">
        <div class="app-main__inner">
            <div class="col-lg-12 app-content">
                <div class="app-content-top-title">Item Groups</div>
                <div class="main-card card app-content-inner">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center table-header-bg py-1 mb-1">
                            <h5 class="f-14">Item Groups</h5>
{{--                            {{ $item_groups->links('vendor.pagination.custom') }}--}}
                            @can('Create Item Group')
                            <a class="nav-link" href="{{route('add.group.management')}}">
                                    ...
                                    <table id="example" class="table-width-100 table table-hover table-striped table-bordered">
                                        ...
                                        @foreach($item_groups as $key=>$value)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    @can('Edit Item Group')
                                                        <a href="{{url('/settings/edit/group-management/'.$value->id)}}">
                                                    ...
                                                    @can('Delete Item Group')
                                                        <form action="{{url('/settings/delete/group-management/'.$value->id)}}" method="post">
                                                            @csrf
