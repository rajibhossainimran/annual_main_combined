...
<div class="app-main__outer">
        <div class="app-main__inner">
            <div class="col-lg-12 app-content">
                <div class="app-content-top-title">Item Types</div>
                <div class="main-card app-content-inner card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center table-header-bg py-1 mb-1">
                            <h5 class="f-14">Item Types</h5>
{{--                            {{ $item_types->links('vendor.pagination.custom') }}--}}
                            @can('Create Item Types')
                            <a class="nav-link" href="{{route('add.item.types')}}">
                                    ...
                                    <table id="example" class="table-width-100 table table-hover table-striped table-bordered">
                                        ...
                                        @foreach($item_types as $key=>$value)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    @can('Edit Item Types')
                                                        <a href="{{url('/settings/edit/item-types/'.$value->id)}}">
                                                    ...
                                                    @can('Delete Item Types')
                                                        <form action="{{url('/settings/delete/item-types/'.$value->id)}}" method="post">
                                                            @csrf
