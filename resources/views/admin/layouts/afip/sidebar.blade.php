...
{{-- <div class="ui-theme-settings">
    ...
    <div class="theme-settings__inner">
        <div class="scrollbar-container ps ps--active-y">
                                        ...
                                        <div class="switch has-switch switch-container-class" data-class="fixed-header">
                                            <div class="switch-animate switch-on">
                                                <div class="toggle btn btn-success" data-toggle="toggle" role="button"
                                                    style="width: 56.5px; height: 33.1875px;"><input type="checkbox"
            ...
            <div class="ps__rail-x" style="left: 0px; bottom: -246px;">
                <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
            </div>
            <div class="ps__rail-y" style="top: 246px; height: 657px; right: 0px;">
                <div class="ps__thumb-y" tabindex="0" style="top: 138px; height: 367px;"></div>
            </div>
        </div>
    </div>
</div> --}}
    ...
    <div class="app-sidebar sidebar-shadow bg-success sidebar-text-light">
        ...
        <div class="scrollbar-sidebar">
            <div class="app-sidebar__inner">
                sa<ul class="vertical-nav-menu" id="all-menus">
                    {{-- <li class="app-sidebar__heading">Menu</li> --}}
                    @foreach ($menus as $k => $menu)
                        <li class="">
                            <a
                                href="@if($menu->common_url != '#'){{route($menu->common_url)}}@else{{'#'}}@endif"><i
                                    class="metismenu-icon pe-7s-rocket"></i>{{ $menu->name }}
                            ...
                            @if (isset($menu->sub_menu) && !empty($menu->sub_menu))
                                <ul>
                                    @foreach ($menu->sub_menu as $sub)
                                        <li class="sub-menus"><a href="{{route($sub->url)}}"><i class="metismenu-icon"></i>
                                                {{ $sub->show_name }} </a></li>
                                    @endforeach
                                </ul>
                            @endif
