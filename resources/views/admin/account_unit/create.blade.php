            ...
            {{-- <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Account Unit<div class="page-title-subheading">Create Account Unit</div>
                        </div>
                    </div>
                ...
                <div class="main-card app-content-inner card">
                    <div class="card-body">
                        <div class="card-title d-flex justify-content-between align-items-center table-header-bg py-1">
                            <h5 class="f-14">Create Account Units</h5>
                            @can('Show Account Units')
                            <a class="nav-link" href="{{route('all.account.units')}}">
                        ...
                        <div class="pb-2">
                            <form action="{{route('store.account.unit')}}" method="post">
                                @csrf
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Account Unit Name <span class="requiredStar">*</span></label>
                                        <input type="text" placeholder="Account Unit Name" required class="form-control" name="name" value="{{ old('name') }}">
                                    </div>
                                    <div class="mt-1">
