                ...
                <div class="main-card app-content-inner card">
                    <div class="card-body">
                        <div class="card-title d-flex justify-content-between align-items-center table-header-bg py-1">
                            <h5 class="f-14">Create Department</h5>
                            @can('Departments')
                        ...
                        <div class="pb-2">
                            <form action="{{route('store.CMHDepartment')}}" method="post">
                                @csrf
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Department Name" required class="form-control" name="name">
                                    </div>
                                    <div class="mt-1">
                                        <button type="submit" class="btn btn-primary mt-1">Add Department</button>
                                    </div>
                                </div>
                            </form>
                        </div>
