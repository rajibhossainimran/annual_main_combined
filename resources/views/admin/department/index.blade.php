                ...
                <div class="main-card card app-content-inner">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center table-header-bg py-1 mb-1">
                            <h5 class="f-14">List of Department</h5>
                            @can('Create Department')
                                <a class="nav-link" href="{{route('add.CMHDepartment')}}">
                                    ...
                                    <table id="example" class="table-width-100 table table-hover table-striped table-bordered">
                                        ...
                                        @foreach($departs as $k=>$data)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    @can('Edit Department')
                                                        <a href="{{url('/settings/edit/cmh/department/'.$data->id)}}">
                                                    ...
                                                    @can('Delete Department')
                                                        <form action="{{url('/settings/delete/cmh/department/'.$data->id)}}" method="post">
                                                            @csrf
