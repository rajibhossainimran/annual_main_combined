    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            <div class="col-lg-12 app-content">
                <div class="app-content-top-title">Stock Transaction (Ward / Department)</div>
                <div class="main-card app-content-inner card">
                    <div class="card-body">
                        <div class="p-2">
                            ...
                            <table class="table table-bordered table-striped fs--1 mb-0 w-100" id="stockPvmsListTransitionTable">
